...
function recoverMnemonic(shares) {
  var hexShares = Object.keys(shares).reduce(function (accum, id) {
    var hexShare = mnemonicToEntropy(shares[id]);
    accum[id] = hexShare;
    return accum;
  }, {});
...
function splitMnemonic(mnemonic, numShares, threshold) {
  ...
  return Object.keys(hexShares).reduce(function (accum, id) {
    var mnemonicShare = entropyToMnemonic(hexShares[id]);
...
export { deriveShare, recoverMnemonic, splitMnemonic };
//# sourceMappingURL=shamir-bip39.esm.js.map
