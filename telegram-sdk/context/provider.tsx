...
const Coin98Provider: React.FC<React.PropsWithChildren<ICoin98Props>> = ({ children, partner, chainId }) => {
  ...
  const handleOpenGateway: FuncHandleOpenGateWay = async (message, callback) => {
    ...
    return await new Promise((resolve, reject) => {
      ...
      mqttClient.current?.on('message', (_topic, data) => {
  ...
  const handleAccountsChanged = async (callback: () => void) => {
    ...
    mqttGeneralClient.current.on('message', (_topic, data) => {
